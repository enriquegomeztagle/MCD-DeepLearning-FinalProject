...
\begin{titlepage}
    ...
    {\large\bfseries\color{neutral}
     Luis Alejandro Guillén Alvarez\\[0.3em]
     Enrique Ulises Báez Gómez Tagle\par}
    ...
    \vspace{0.4cm}
    {\normalsize Plataforma en vivo: \href{https://srv7050.tailc60ea4.ts.net/}{srv7050.tailc60ea4.ts.net}\par}
